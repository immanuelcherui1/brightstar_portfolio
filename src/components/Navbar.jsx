...
const Navbar = () => {
  ...
  return (
    <Nav>
      <NavbarContainer>
        <NavLogo to="/">
          <ColorText>&lt;</ColorText>Brightstar
          <div style={{ color: theme.primary }}>/</div>Kasyoka
          <ColorText>&gt;</ColorText>
        </NavLogo>
        ...
        {isOpen && (
          <MobileMenu isOpen={isOpen}>
            ...
            <NavLink onClick={() => setIsOpen(!isOpen)} href="#Engagements">
              Engagements
            </NavLink>
            <NavLink onClick={() => setIsOpen(!isOpen)} href="#Honours">
              Honours & Awards
            </NavLink>
